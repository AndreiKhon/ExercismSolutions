...
namespace estate_executor {
    ...
    int assemble_code() {
        auto red_sum{zhang::red::code_fragment() + khan::red::code_fragment() + garcia::red::code_fragment()};
        auto blue_sum{zhang::blue::code_fragment() + khan::blue::code_fragment() + garcia::blue::code_fragment()};
